...
const QUESTOES_PCAL_LOTE48 = [
  ...
  /* ===== CRIMES COMUNS x FUNCIONAIS (LEI 8.137/1990, ARTS. 1º A 3º) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (sujeito ativo).",
      pegadinhaDesc: "A banca pode generalizar, afirmando que todos os crimes tributários são próprios e exclusivos de quem exerce poder de decisão em estabelecimento privado.",
      ondeErra: "Confunde a regra (crime comum, arts. 1º e 2º) com a exceção (crime próprio/funcional, art. 3º), invertendo ou generalizando indevidamente.",
      palavraCritica: "crimes comuns ... crimes próprios",
      tecnica: "Os crimes contra a ordem tributária dos arts. 1º e 2º da Lei 8.137/1990 são COMUNS: podem ser praticados por qualquer pessoa com dever jurídico relacionado ao tributo (contribuinte, responsável, administrador, contador), sem exigência de qualidade especial. Já os crimes FUNCIONAIS do art. 3º são crimes PRÓPRIOS, exigindo a condição de funcionário público, praticados no âmbito da administração fazendária.",
      regraMental: "Arts. 1º e 2º: crime comum (qualquer um). Art. 3º: crime próprio (só funcionário público)."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (sujeito ativo).",
      pegadinhaDesc: "A banca generaliza indevidamente a exceção (crime próprio) para todos os crimes tributários da lei.",
      ondeErra: "Ignora que a Lei 8.137/1990 prevê, na maioria de seus tipos (arts. 1º e 2º), crimes comuns, praticáveis por qualquer pessoa.",
      palavraCritica: "em sua totalidade ... exclusivamente",
      tecnica: "Apenas os crimes funcionais do art. 3º da Lei 8.137/1990 são próprios, exigindo a condição de funcionário público. Os crimes dos arts. 1º e 2º são comuns, podendo ser praticados por qualquer pessoa com dever jurídico relacionado ao tributo — não há exclusividade a quem exerce poder de decisão em estabelecimento privado.",
      regraMental: "Nunca generalizar 'crime próprio' para toda a Lei 8.137/1990 — isso só vale para o art. 3º."
    },
    comentario: {
  ...
  /* ===== NOTA FISCAL — CRIME COMUM PUNIDO COM RECLUSÃO (ART. 1º, V) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (art. 1º, V).",
      pegadinhaDesc: "A banca pode classificar essa conduta como crime funcional e/ou trocar a pena de reclusão por detenção.",
      ondeErra: "Acredita que essa conduta exige a condição de funcionário público, ou que sua pena é de detenção.",
      palavraCritica: "crime ... comum ... reclusão",
      tecnica: "O art. 1º, V, da Lei 8.137/1990 tipifica negar ou deixar de fornecer, quando obrigatório, nota fiscal ou documento equivalente relativo a venda de mercadoria ou prestação de serviço efetivamente realizada, ou fornecê-la em desacordo com a legislação. É crime COMUM (praticado pelo contribuinte, não exige funcionário público), com pena de RECLUSÃO de 2 a 5 anos, e multa — nunca detenção.",
      regraMental: "Nota fiscal não fornecida (art. 1º, V): crime comum + reclusão (2 a 5 anos). Nunca funcional, nunca detenção."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (art. 1º, V).",
      pegadinhaDesc: "A banca junta dois erros na mesma assertiva: classifica a conduta como funcional e atribui-lhe pena de detenção.",
      ondeErra: "Aceita que a conduta do art. 1º, V, exige a condição de funcionário público e é punida com detenção.",
      palavraCritica: "crime funcional ... detenção",
      tecnica: "A conduta de negar ou deixar de fornecer nota fiscal (art. 1º, V, da Lei 8.137/1990) é crime contra a ordem tributária COMUM, praticado pelo contribuinte, sem exigir a condição de funcionário público. A pena é de RECLUSÃO, de 2 a 5 anos, e multa — não detenção.",
      regraMental: "'Funcional' + 'detenção' juntos, para o art. 1º, V: sempre errado. É comum + reclusão."
    },
    comentario: {
  ...
  /* ===== MERO INADIMPLEMENTO NÃO É CRIME — EXIGÊNCIA DE DOLO/FRAUDE ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (elemento subjetivo).",
      pegadinhaDesc: "A banca pode afirmar que o simples recolhimento a menor, mesmo sem fraude, já configura crime punível com reclusão.",
      ondeErra: "Confunde o inadimplemento tributário simples (ilícito administrativo) com a supressão/redução fraudulenta de tributo (crime).",
      palavraCritica: "não caracteriza crime ... exclusivamente na esfera administrativa",
      tecnica: "Os crimes contra a ordem tributária da Lei 8.137/1990 exigem dolo (vontade livre e consciente de suprimir ou reduzir tributo) e, em regra, fraude ou simulação. O mero recolhimento de tributo a menor, sem esses elementos, não é crime: resolve-se exclusivamente na esfera administrativa, por meio de cobrança tributária, juros e multa moratória.",
      regraMental: "Sem dolo/fraude, não há crime tributário — só ilícito administrativo (cobrança + juros + multa)."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária (elemento subjetivo).",
      pegadinhaDesc: "A banca dispensa expressamente o dolo/fraude, tratando a mera discrepância de valores como suficiente para o crime.",
      ondeErra: "Acredita que os crimes tributários são de natureza objetiva, prescindindo de dolo ou fraude para sua configuração.",
      palavraCritica: "ainda que não comprovada fraude dolosa ... por si só, suficiente",
      tecnica: "Os crimes contra a ordem tributária da Lei 8.137/1990 exigem, indispensavelmente, a presença do dolo e, em regra, o emprego de fraude ou simulação. Ausente a comprovação do dolo ou da fraude, a conduta do contribuinte resolve-se exclusivamente na esfera administrativa, não sendo passível de sanção penal, muito menos de pena de reclusão.",
      regraMental: "Discrepância de valores, sozinha, nunca basta — falta o dolo/fraude para virar crime."
    },
    comentario: {
  ...
  /* ===== RELAÇÕES DE CONSUMO — DESTINAÇÃO COMERCIAL (ART. 7º, IX) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra as relações de consumo (art. 7º, IX).",
      pegadinhaDesc: "A banca pode afirmar que basta ter a mercadoria em depósito, independentemente da finalidade, para configurar o crime.",
      ondeErra: "Ignora que a expressão 'para vender' qualifica o núcleo 'ter em depósito', exigindo a destinação comercial.",
      palavraCritica: "para vender ... destinação comercial",
      tecnica: "O art. 7º, IX, da Lei 8.137/1990 pune vender, ter em depósito PARA VENDER ou expor à venda, ou, de qualquer forma, entregar matéria-prima ou mercadoria em condições impróprias ao consumo. O núcleo 'ter em depósito' é qualificado pela destinação comercial — sem essa finalidade, a conduta é atípica quanto a esse inciso.",
      regraMental: "'Ter em depósito' só é crime se for PARA VENDER — sem essa finalidade, não há tipicidade no inciso IX."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra as relações de consumo (art. 7º, IX).",
      pegadinhaDesc: "A banca retira exatamente o elemento (destinação comercial) que torna a conduta típica, mas ainda assim afirma haver crime.",
      ondeErra: "Acredita que a mera posse de mercadoria imprópria, sem qualquer finalidade comercial, já configura o crime do art. 7º, IX.",
      palavraCritica: "mesmo que não seja para vender ... mera posse",
      tecnica: "O núcleo 'ter em depósito', no art. 7º, IX, da Lei 8.137/1990, é qualificado pela destinação comercial ('para vender'). Sem essa finalidade, a conduta é atípica quanto a esse inciso — a mera posse da mercadoria imprópria para consumo próprio, por exemplo, não configura esse crime específico.",
      regraMental: "Sem finalidade comercial, não há tipicidade no art. 7º, IX — a pegadinha retira exatamente esse elemento e ainda afirma haver crime."
    },
    comentario: {
  ...
  /* ===== AGRAVANTE DO ART. 12 — SERVIDOR PÚBLICO NO EXERCÍCIO DAS FUNÇÕES ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária, econômica e relações de consumo (agravantes, art. 12).",
      pegadinhaDesc: "A banca pode negar a aplicação dessa agravante aos crimes contra as relações de consumo, restringindo-a apenas aos crimes tributários.",
      ondeErra: "Acha que a agravante do art. 12 só se aplica aos crimes tributários (arts. 1º e 2º), não alcançando os crimes contra as relações de consumo (art. 7º).",
      palavraCritica: "agravar, de um terço até a metade",
      tecnica: "O art. 12, II, da Lei 8.137/1990 prevê que ser o crime cometido por servidor público no exercício de suas funções agrava de 1/3 até a metade as penas previstas nos arts. 1º, 2º e 4º a 7º — e os crimes contra as relações de consumo estão justamente no art. 7º, sendo alcançados por essa agravante.",
      regraMental: "Agravante do art. 12 alcança arts. 1º, 2º e 4º a 7º — inclui relações de consumo (art. 7º), mas não o art. 3º."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem tributária, econômica e relações de consumo (agravantes, art. 12).",
      pegadinhaDesc: "A banca estende a agravante de servidor público também aos crimes funcionais do art. 3º, o que configuraria bis in idem.",
      ondeErra: "Não percebe que, no art. 3º, a condição de funcionário público já é elementar do próprio tipo penal — não pode ser usada, ao mesmo tempo, como agravante.",
      palavraCritica: "aplica-se ... ao art. 3º",
      tecnica: "O art. 12 da Lei 8.137/1990 agrava as penas dos arts. 1º, 2º e 4º a 7º — o art. 3º fica de fora dessa lista justamente porque, nos crimes funcionais, ser funcionário público já é elementar do tipo. Usar a mesma circunstância como elementar e como agravante ao mesmo tempo constituiria bis in idem.",
      regraMental: "Art. 3º nunca recebe a agravante de 'servidor público' — essa condição já é elementar do próprio crime funcional."
    },
    comentario: {
  ...
  /* ===== GLP PARA FINS AUTOMOTIVOS (LEI 8.176/1991, ART. 1º, II, REDAÇÃO DA LEI 15.348/2026) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem econômica (Lei 8.176/1991, combustíveis).",
      pegadinhaDesc: "A banca pode manter a redação anterior, afirmando que o uso irregular de GLP em saunas, caldeiras ou aquecimento de piscinas ainda é crime.",
      ondeErra: "Desconhece a Lei 15.348/2026, que restringiu o tipo penal apenas ao uso automotivo, descriminalizando as demais hipóteses.",
      palavraCritica: "apenas ... fins automotivos ... descriminalizado",
      tecnica: "O art. 1º, II, da Lei 8.176/1991, com a redação dada pela Lei 15.348/2026, criminaliza exclusivamente o uso de gás liquefeito de petróleo para fins automotivos em desacordo com as normas estabelecidas em lei. A redação anterior também previa como crime o uso irregular em motores de qualquer espécie, saunas, caldeiras e aquecimento de piscinas — hipóteses que deixaram de ser crime com a atualização legislativa.",
      regraMental: "Desde a Lei 15.348/2026: GLP irregular só é crime se for para fins AUTOMOTIVOS. As demais hipóteses foram descriminalizadas."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem econômica (Lei 8.176/1991, combustíveis).",
      pegadinhaDesc: "A banca afirma que o alcance do tipo permanece inalterado desde 1991, ignorando a atualização legislativa de 2026.",
      ondeErra: "Desconhece que a Lei 15.348/2026 restringiu o crime apenas ao uso automotivo do GLP, descriminalizando as demais hipóteses anteriormente previstas.",
      palavraCritica: "seja em motores de qualquer espécie ... inalterado",
      tecnica: "A redação atual do art. 1º, II, da Lei 8.176/1991 (dada pela Lei 15.348/2026) restringe o crime ao uso de GLP para fins automotivos em desacordo com as normas. O uso irregular em motores de qualquer espécie, saunas, caldeiras e aquecimento de piscinas — antes também criminalizado — deixou de ser crime com a atualização legislativa de 2026.",
      regraMental: "O tipo NÃO está mais inalterado desde 1991 — a Lei 15.348/2026 restringiu-o só ao uso automotivo."
    },
    comentario: {
  ...
  /* ===== USURPAÇÃO — EQUIPARAÇÃO DE QUEM TRANSPORTA/COMERCIALIZA (LEI 8.176/1991, ART. 2º, § 1º) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem econômica (usurpação, Lei 8.176/1991, art. 2º).",
      pegadinhaDesc: "A banca pode afirmar que só responde pelo crime quem participou diretamente da extração/exploração do bem da União.",
      ondeErra: "Acha que o transporte ou a comercialização do produto ilicitamente extraído, por quem não participou da extração, é conduta atípica.",
      palavraCritica: "ainda que não tenha participado diretamente da extração",
      tecnica: "O art. 2º, § 1º, da Lei 8.176/1991 prevê que incorre na mesma pena do caput (usurpação) quem, sem autorização legal, adquirir, transportar, industrializar, tiver consigo, consumir ou comercializar produtos ou matéria-prima obtidos por meio de exploração ilegal de bem da União — conduta equiparada, que não exige participação direta na extração.",
      regraMental: "Quem transporta/comercializa produto de mina clandestina, sabendo da origem, responde igual a quem extraiu — conduta equiparada do § 1º."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — crimes contra a ordem econômica (usurpação, Lei 8.176/1991, art. 2º).",
      pegadinhaDesc: "A banca restringe a responsabilidade penal apenas a quem executou a extração, tornando atípica a conduta de quem transporta/comercializa.",
      ondeErra: "Ignora a conduta equiparada do § 1º do art. 2º, que pune quem transporta, comercializa, adquire ou tem consigo o produto de origem ilícita, mesmo sem ter extraído.",
      palavraCritica: "somente responde ... atípica a conduta ... transporta ou comercializa",
      tecnica: "O art. 2º, § 1º, da Lei 8.176/1991 pune, com a mesma pena da usurpação, quem, sem autorização legal, adquirir, transportar, industrializar, tiver consigo, consumir ou comercializar produto obtido mediante exploração ilegal de bem da União — a conduta de transportar ou comercializar o produto, ciente de sua origem ilícita, é TÍPICA, ainda que o agente não tenha participado da extração.",
      regraMental: "Transportar/comercializar produto de origem ilícita, sabendo disso, é sempre típico — nunca 'atípico' por não ter extraído."
    },
    comentario: {
