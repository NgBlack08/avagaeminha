...
const QUESTOES_PCAL_LOTE49 = [
  ...
  /* ===== ORIGEM ILÍCITA COMO PRESSUPOSTO DO TIPO (ART. 1º) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (art. 1º, natureza acessória/parasitária).",
      pegadinhaDesc: "A banca pode afirmar que qualquer processo de desvinculação de recursos de sua origem constitui lavagem, mesmo quando a origem é lícita.",
      ondeErra: "Ignora que o objeto material do crime são bens 'provenientes, direta ou indiretamente, de infração penal' — sem essa origem ilícita, não há lavagem.",
      palavraCritica: "origem exclusivamente lícita ... falta o pressuposto do tipo",
      tecnica: "O art. 1º da Lei 9.613/1998 pune ocultar ou dissimular a natureza, origem, localização, disposição, movimentação ou propriedade de bens, direitos ou valores provenientes, direta ou indiretamente, de infração penal. A lavagem é crime acessório (parasitário): sem uma infração penal antecedente produtora dos recursos, falta o pressuposto do tipo, e a conduta de desvincular recursos lícitos de sua origem pode configurar, no máximo, outro delito — jamais lavagem de capitais.",
      regraMental: "Sem origem ilícita, não há lavagem — é crime parasitário, sempre depende de uma infração penal antecedente."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (art. 1º, natureza acessória/parasitária).",
      pegadinhaDesc: "A banca afirma expressamente que a lei dispensa a origem ilícita, quando na verdade essa origem é elemento nuclear do tipo.",
      ondeErra: "Acredita que a mera desvinculação de recursos lícitos de sua operação de origem, por si só, configura lavagem de dinheiro.",
      palavraCritica: "ainda que ... obtidos licitamente ... não exige a origem ilícita",
      tecnica: "O art. 1º da Lei 9.613/1998 exige que os bens ocultados ou dissimulados sejam provenientes, direta ou indiretamente, de infração penal. Recursos obtidos licitamente não podem ser objeto do crime de lavagem — falta o pressuposto do tipo, ao contrário do que afirma o item.",
      regraMental: "A lei EXIGE origem ilícita — nunca dispensa esse elemento. Recursos lícitos nunca configuram lavagem."
    },
    comentario: {
  ...
  /* ===== TERCEIRO QUE NÃO PARTICIPOU DO CRIME ANTECEDENTE (CRIME COMUM) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (sujeito ativo).",
      pegadinhaDesc: "A banca pode afirmar que só responde por lavagem quem também participou, como autor ou partícipe, do crime antecedente.",
      ondeErra: "Acha que a lavagem exige a participação prévia do agente no crime que gerou os valores ilícitos.",
      palavraCritica: "terceiro que nunca tenha integrado o crime antecedente",
      tecnica: "A lavagem de dinheiro é crime comum: qualquer pessoa pode ser sujeito ativo, inclusive um terceiro (o 'lavador profissional') que nunca integrou o crime antecedente, bastando que oculte ou dissimule bens dele provenientes (art. 1º), já que o processo por lavagem independe do processo e julgamento do crime antecedente (art. 2º, II).",
      regraMental: "Lavagem: qualquer pessoa pode praticar, mesmo quem nunca participou do crime-base que gerou o dinheiro."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (sujeito ativo).",
      pegadinhaDesc: "A banca cria um requisito inexistente (participação no crime antecedente) para restringir indevidamente o sujeito ativo da lavagem.",
      ondeErra: "Acredita que apenas quem cometeu o crime-base (autolavagem) pode responder por lavagem, excluindo terceiros.",
      palavraCritica: "é necessário que o agente tenha participado ... não podendo um terceiro",
      tecnica: "A lavagem de dinheiro é crime comum, e não se exige que o agente tenha participado do crime antecedente. Um terceiro que nunca integrou o crime-base pode ser sujeito ativo, bastando que oculte ou dissimule bens dele provenientes (art. 1º), já que o processo por lavagem independe do processo do crime antecedente (art. 2º, II).",
      regraMental: "Não existe exigência de participação no crime antecedente — a lavagem admite terceiros que nunca integraram o crime-base."
    },
    comentario: {
  ...
  /* ===== CAUSA DE AUMENTO — ATIVO VIRTUAL, REITERAÇÃO, ORGANIZAÇÃO CRIMINOSA (ART. 1º, § 4º) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (causa de aumento, art. 1º, § 4º).",
      pegadinhaDesc: "A banca pode afirmar que as três hipóteses devem ocorrer cumulativamente para a incidência da majorante.",
      ondeErra: "Acha que é preciso a presença simultânea de reiteração, organização criminosa e uso de ativo virtual para aplicar o aumento.",
      palavraCritica: "hipóteses alternativas ... bastando a incidência de uma delas",
      tecnica: "O art. 1º, § 4º, da Lei 9.613/1998 prevê aumento de 1/3 a 2/3 se o crime for cometido de forma reiterada, por intermédio de organização criminosa ou por meio da utilização de ativo virtual (esta última hipótese incluída pela Lei 14.478/2022, marco legal dos criptoativos). São hipóteses alternativas e autônomas — basta uma delas para a majorante incidir.",
      regraMental: "Art. 1º, §4º: reiteração OU organização criminosa OU ativo virtual — qualquer uma já aumenta a pena de 1/3 a 2/3."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (causa de aumento, art. 1º, § 4º).",
      pegadinhaDesc: "A banca exige a cumulação das três hipóteses, quando a lei as trata como alternativas e autônomas.",
      ondeErra: "Interpreta as três hipóteses do § 4º como requisitos cumulativos, quando na verdade cada uma, isoladamente, já basta.",
      palavraCritica: "somente ... simultaneamente ... não bastando a ocorrência isolada",
      tecnica: "O art. 1º, § 4º, da Lei 9.613/1998 prevê três hipóteses ALTERNATIVAS e autônomas de causa de aumento (reiteração, organização criminosa, ativo virtual) — basta a ocorrência de qualquer uma delas, isoladamente, para a majorante de 1/3 a 2/3 incidir, não sendo necessária a cumulação das três.",
      regraMental: "Nunca exigir as três hipóteses juntas — cada uma, sozinha, já é suficiente para o aumento."
    },
    comentario: {
  ...
  /* ===== COLABORAÇÃO PREMIADA — SEM EXIGÊNCIA DE ACORDO PRÉVIO (ART. 1º, § 5º) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (colaboração premiada, art. 1º, § 5º).",
      pegadinhaDesc: "A banca pode exigir que o acordo seja necessariamente homologado antes do oferecimento da denúncia, sob pena de nulidade.",
      ondeErra: "Acredita que a ausência de um acordo formal prévio, homologado antes da denúncia, impede a concessão dos benefícios da colaboração.",
      palavraCritica: "a qualquer tempo ... não havendo exigência",
      tecnica: "O art. 1º, § 5º, da Lei 9.613/1998 faculta ao juiz reduzir a pena, deixar de aplicá-la ou substituí-la 'a qualquer tempo', quando o autor, coautor ou partícipe colaborar espontaneamente com as autoridades. A colaboração é ato que pode ser valorado a qualquer momento do processo, não exigindo acordo formal prévio homologado antes da denúncia.",
      regraMental: "Colaboração na lavagem: benefício aplicável 'a qualquer tempo', sem exigência de acordo prévio formalizado antes da denúncia."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (colaboração premiada, art. 1º, § 5º).",
      pegadinhaDesc: "A banca cria uma formalidade e uma sanção (nulidade) que a Lei 9.613/1998 não prevê para a colaboração premiada.",
      ondeErra: "Confunde o regime específico da colaboração na Lei de Lavagem com formalidades de outros institutos, criando uma exigência inexistente.",
      palavraCritica: "exige acordo homologado ... sob pena de nulidade",
      tecnica: "O art. 1º, § 5º, da Lei 9.613/1998 permite que os benefícios da colaboração espontânea sejam aplicados pelo juiz 'a qualquer tempo' — não há exigência de acordo formal homologado antes da denúncia, nem previsão de nulidade pela ausência dessa formalidade.",
      regraMental: "Não existe 'nulidade por falta de acordo prévio' na colaboração da Lei de Lavagem — o benefício subsiste a qualquer tempo."
    },
    comentario: {
  ...
  /* ===== MEDIDAS ASSECURATÓRIAS — OITIVA OBRIGATÓRIA DO MP (ART. 4º-B) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (medidas assecuratórias, art. 4º-B).",
      pegadinhaDesc: "A banca pode dispensar a oitiva do Ministério Público sob o argumento da urgência da medida.",
      ondeErra: "Acha que, por se tratar de medida urgente, a manifestação do Ministério Público pode ser dispensada.",
      palavraCritica: "ouvido o Ministério Público",
      tecnica: "O art. 4º-B da Lei 9.613/1998 prevê que a ordem de prisão de pessoas ou as medidas assecuratórias de bens, direitos ou valores poderão ser suspensas pelo juiz, sempre OUVIDO O MINISTÉRIO PÚBLICO, quando a execução imediata puder comprometer as investigações — a oitiva do MP é pressuposto do ato, não dispensável em nenhuma hipótese.",
      regraMental: "Suspensão de prisão/medidas assecuratórias na lavagem: sempre com o MP ouvido antes, nunca dispensado."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (medidas assecuratórias, art. 4º-B).",
      pegadinhaDesc: "A banca dispensa a oitiva do MP sob o pretexto da urgência processual, contrariando o texto expresso do art. 4º-B.",
      ondeErra: "Acredita que situações urgentes autorizam o juiz a agir sem ouvir previamente o Ministério Público.",
      palavraCritica: "sendo dispensada a oitiva do Ministério Público",
      tecnica: "O art. 4º-B da Lei 9.613/1998 exige que a suspensão da ordem de prisão ou das medidas assecuratórias seja feita pelo juiz sempre OUVIDO O MINISTÉRIO PÚBLICO — a urgência do ato não dispensa essa oitiva, que é pressuposto do ato, e não uma formalidade descartável.",
      regraMental: "Urgência nunca dispensa a oitiva do MP na suspensão de medidas assecuratórias/prisão da Lei de Lavagem."
    },
    comentario: {
  ...
  /* ===== AFASTAMENTO DE SERVIDOR PÚBLICO INDICIADO — SEM PREJUÍZO DE REMUNERAÇÃO (ART. 17-D) ===== */
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (afastamento de servidor público, art. 17-D).",
      pegadinhaDesc: "A banca pode inverter a regra, afirmando que o afastamento se dá com prejuízo de remuneração.",
      ondeErra: "Acha que o afastamento do servidor indiciado implica a suspensão de sua remuneração até a decisão final.",
      palavraCritica: "sem prejuízo de sua remuneração ... decisão fundamentada",
      tecnica: "O art. 17-D da Lei 9.613/1998 determina que, em caso de indiciamento de servidor público por lavagem, este será afastado do cargo, emprego ou função, SEM PREJUÍZO de remuneração e demais direitos previstos em lei, até que o juiz competente autorize, em decisão fundamentada, seu retorno — o STF, ademais, afastou a possibilidade de afastamento automático pelo simples indiciamento, exigindo decisão judicial fundamentada.",
      regraMental: "Afastamento do servidor indiciado por lavagem: sempre SEM prejuízo de remuneração, mediante decisão judicial fundamentada."
    },
    comentario: {
  ...
  },
  {
    ...
    cognitivo: {
      ...
      mede: "Legislação Especial — Lavagem de Dinheiro (afastamento de servidor público, art. 17-D).",
      pegadinhaDesc: "A banca inverte a proteção remuneratória do art. 17-D e trata o afastamento como automático, ignorando a exigência de decisão judicial fundamentada.",
      ondeErra: "Acredita que o afastamento decorre automaticamente do indiciamento e implica a perda da remuneração.",
      palavraCritica: "afastado imediatamente ... com prejuízo de remunerações",
      tecnica: "O art. 17-D da Lei 9.613/1998 determina que o servidor indiciado por lavagem será afastado SEM PREJUÍZO de remuneração e demais direitos, até que o juiz competente autorize, em decisão fundamentada, seu retorno. O STF, ademais, afastou a possibilidade de afastamento automático pelo simples indiciamento — a medida depende de decisão judicial fundamentada, observados os requisitos cautelares.",
      regraMental: "Nunca é 'com prejuízo de remuneração' nem 'automático' — é sempre sem prejuízo remuneratório e com decisão judicial fundamentada."
    },
    comentario: {
